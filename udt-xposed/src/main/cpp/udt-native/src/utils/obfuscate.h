...
namespace ay
{
    ...
    public:
        ...
        AY_CONSTEVAL explicit obfuscator(const CHAR_TYPE* data)
        {
            // Copy data
...
#ifdef NDEBUG
#define XSTR(data) static_cast<const char*>(AY_OBFUSCATE(data))
#else
#define XSTR(data) ([]() -> const char* {static const char* str = data; return str;}())
#endif
